...
S3 access uses your local AWS configuration (static keys, SSO, and `aws login` profiles all work; `awscrt` is bundled). To pick a specific profile from your AWS config, pass `--profile <name>`:
